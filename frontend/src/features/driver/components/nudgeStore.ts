...
// - only kinds this client can render enter the queue (the bypassed stop and
//   the custody confirm; U10 adds the remote-absent card).
...
export const RENDERABLE_KINDS: ReadonlySet<string> = new Set(["stop-bypassed", "custody-away"]);
