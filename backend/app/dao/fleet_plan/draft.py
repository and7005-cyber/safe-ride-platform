"""Fleet confirmation, draft generation, reads and discard (F1/F4/U4).

One method group of ``FleetPlanDao`` — ``app.dao.fleet_plan_dao`` composes
it with the review, apply/restore and slot-in groups and stays the import
...
class DraftOps:
    """Fleet confirmation, draft generation, plan reads and discard."""
