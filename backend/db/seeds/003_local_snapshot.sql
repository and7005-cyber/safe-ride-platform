...
INSERT INTO public.run_positions (id, school_id, run_id, bus_id, source, action_kind, action_key, lat, lng, accuracy_m, captured_at, received_at, fix_reason, flags) VALUES
  ('70160000-0000-0000-0000-000000000001', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '146a1837-af5e-494c-8be6-f78db9c4280a', 'checkpoint', 'start',  NULL,                                   -1.333667, 36.73547, NULL, NULL,                      now() - interval '2 days' + interval '0 seconds', NULL, '{}'),
  ('70160000-0000-0000-0000-000000000002', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '146a1837-af5e-494c-8be6-f78db9c4280a', 'action',     'arrive', '71160000-0000-0000-0000-000000000002', -1.29035,  36.78215, 18.5, now() - interval '2 days' + interval '24 seconds', now() - interval '2 days' + interval '25 seconds', NULL, '{}'),
  ('70160000-0000-0000-0000-000000000003', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '146a1837-af5e-494c-8be6-f78db9c4280a', 'action',     'board',  '71160000-0000-0000-0000-000000000003', -1.29018,  36.78244, 22.0, now() - interval '2 days' + interval '39 seconds', now() - interval '2 days' + interval '40 seconds', NULL, '{}')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.run_exceptions (id, school_id, run_id, stop_order, student_id, kind, reason, fix_lat, fix_lng, fix_accuracy_m, fix_captured_at, distance_m, seen_at_stop, created_at, reviewed_at, reviewed_by) VALUES
  ('72160000-0000-0000-0000-000000000001', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', 2,    '50000000-0000-0000-0000-000000000003', 'custody-away',         NULL,          -1.2952, 36.7810, 20.0,  now() - interval '2 days' + interval '44 seconds', 2280.0, false, now() - interval '2 days' + interval '44 seconds', now() - interval '2 days' + interval '4134 seconds', 'a0000000-0000-0000-0000-000000000011'),
  ('72160000-0000-0000-0000-000000000002', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', 1,    NULL,                                   'stop-bypassed',        NULL,          NULL,    NULL,    NULL,  NULL,                     NULL,   NULL,  now() - interval '2 days' + interval '49 seconds', NULL, NULL),
  ('72160000-0000-0000-0000-000000000003', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', 3,    '50000000-0000-0000-0000-000000000004', 'absent-remote',        NULL,          -1.2902, 36.7823, 25.0,  now() - interval '2 days' + interval '52 seconds', 5100.0, false, now() - interval '2 days' + interval '52 seconds', NULL, NULL),
  ('72160000-0000-0000-0000-000000000004', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', 1,    '50000000-0000-0000-0000-000000000001', 'absent-attested',      NULL,          -1.2789, 36.7685, 30.0,  now() - interval '2 days' + interval '54 seconds', 1900.0, NULL,  now() - interval '2 days' + interval '54 seconds', NULL, NULL),
  ('72160000-0000-0000-0000-000000000005', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', 2,    '50000000-0000-0000-0000-000000000003', 'unverified',           'too-coarse',  -1.2800, 36.7700, 900.0, now() - interval '2 days' + interval '59 seconds', NULL,   NULL,  now() - interval '2 days' + interval '59 seconds', NULL, NULL),
  ('72160000-0000-0000-0000-000000000006', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', NULL, NULL,                                   'implausible-movement', 'jump',        -1.3300, 36.7350, 5.0,   now() - interval '2 days' + interval '64 seconds', 5200.0, NULL,  now() - interval '2 days' + interval '64 seconds', NULL, NULL)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.run_exception_events (id, exception_id, school_id, run_id, student_id, action_key, fix_lat, fix_lng, fix_accuracy_m, fix_captured_at, distance_m, prompt_state, delivered_at, shown_at, response, call_now_due_at, call_now_sent_at, created_at) VALUES
  ('73160000-0000-0000-0000-000000000001', '72160000-0000-0000-0000-000000000001', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '50000000-0000-0000-0000-000000000003', '71160000-0000-0000-0000-000000000004', -1.2952, 36.7810, 20.0,  now() - interval '2 days' + interval '44 seconds', 2280.0, 'answered', now() - interval '2 days' + interval '45 seconds', now() - interval '2 days' + interval '46 seconds', 'confirmed',   NULL,                     NULL,                     now() - interval '2 days' + interval '44 seconds'),
  ('73160000-0000-0000-0000-000000000002', '72160000-0000-0000-0000-000000000002', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '50000000-0000-0000-0000-000000000001', '71160000-0000-0000-0000-000000000005', NULL,    NULL,    NULL,  NULL,                     NULL,   'answered', now() - interval '2 days' + interval '50 seconds', now() - interval '2 days' + interval '51 seconds', 'resolution',  NULL,                     NULL,                     now() - interval '2 days' + interval '49 seconds'),
  ('73160000-0000-0000-0000-000000000003', '72160000-0000-0000-0000-000000000003', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '50000000-0000-0000-0000-000000000004', '71160000-0000-0000-0000-000000000006', -1.2902, 36.7823, 25.0,  now() - interval '2 days' + interval '52 seconds', 5100.0, 'answered', now() - interval '2 days' + interval '53 seconds', now() - interval '2 days' + interval '53 seconds', 'not-at-stop', now() - interval '2 days' + interval '54 seconds', now() - interval '2 days' + interval '56 seconds', now() - interval '2 days' + interval '52 seconds'),
  ('73160000-0000-0000-0000-000000000004', '72160000-0000-0000-0000-000000000004', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '50000000-0000-0000-0000-000000000001', '71160000-0000-0000-0000-000000000007', -1.2789, 36.7685, 30.0,  now() - interval '2 days' + interval '54 seconds', 1900.0, 'answered', now() - interval '2 days' + interval '55 seconds', now() - interval '2 days' + interval '55 seconds', 'told-me',     NULL,                     NULL,                     now() - interval '2 days' + interval '54 seconds'),
  ('73160000-0000-0000-0000-000000000005', '72160000-0000-0000-0000-000000000005', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', '50000000-0000-0000-0000-000000000003', '71160000-0000-0000-0000-000000000008', -1.2800, 36.7700, 900.0, now() - interval '2 days' + interval '59 seconds', NULL,   NULL,       NULL,                     NULL,                     NULL,          NULL,                     NULL,                     now() - interval '2 days' + interval '59 seconds'),
  ('73160000-0000-0000-0000-000000000006', '72160000-0000-0000-0000-000000000006', '5cae0000-0000-0000-0000-000000000001', 'c78b07bb-d18e-4caa-a21c-976bdc489743', NULL,                                   '71160000-0000-0000-0000-000000000009', -1.3300, 36.7350, 5.0,   now() - interval '2 days' + interval '64 seconds', 5200.0, NULL,       NULL,                     NULL,                     NULL,          NULL,                     NULL,                     now() - interval '2 days' + interval '64 seconds')
ON CONFLICT (id) DO NOTHING;
